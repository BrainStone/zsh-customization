...
export ZSH_WINDOW_TITLE_ACTIVE='${ZSH_WINDOW_TITLE_PREFIX:+"${ZSH_WINDOW_TITLE_PREFIX} - "}%$ZSH_WINDOW_TITLE_DIRECTORY_DEPTH~ - %40>...>${${(q)1}//\%/%%}%>>${ZSH_WINDOW_TITLE_SUFFIX:+" - ${ZSH_WINDOW_TITLE_SUFFIX}"}'
